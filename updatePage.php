					...
					<div class='col-lg-3'  >
						<div class='panel panel-default'>
							...
							<div class='panel-body'>
							  ...
							  <form class='form-horizontal' action='updateContact.php' onsubmit='return validForm()' method='post' >
								...
								<div class='form-group'>
								  ...
								  <input type='text' class='form-control'name='note'id='note' value='".$row["note"]."' >
									...
									<div class='panel-footer'>
										<button class='btn btn-primary btn-block' type='submit' id='submit' >Save Changes</button>
										<button type='button' class='btn btn-warning btn-block' onclick='window.location.href=\"homePage.php\"'>
											Cancel
										</button>
									</div>
